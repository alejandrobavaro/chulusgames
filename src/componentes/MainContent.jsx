        ...
        <section className="newsSection">
          ...
          <div className="newsRow">
            <div className="gridItem newsItem">
              ...
              <img src="../../public/img/05-img-costados-larga/1.jpeg" alt="Noticia 1" />
            </div>
            ...
            <div className="gridItem newsItem">
              ...
              <img src="../../public/img/05-img-costados-larga/3.jpeg" alt="Noticia 2" />
            </div>
            ...
            <div className="gridItem newsItem">
              ...
              <img src="../../public/img/05-img-costados-larga/4.jpeg" alt="Noticia 3" />
            </div>
          </div>
        </section>
        ...
        <section className="adSection">
          ...
          <div className="adRow">
            <div className="gridItem adItem">
              <img src="../../public/img/05-img-costados-larga/5.jpeg" alt="Anuncio 1" />
            ...
            <div className="gridItem adItem">
              <img src="../../public/img/05-img-costados-larga/6.jpeg" alt="Anuncio 2" />
            ...
            <div className="gridItem adItem">
              <img src="../../public/img/05-img-costados-larga/7.jpeg" alt="Anuncio 3" />
        ...
        <section className="tournamentSection">
          ...
          <div className="tournamentRow">
            <div className="gridItem tournamentItem">
              ...
              <img src="../../public/img/05-img-costados-larga/8.jpeg" alt="Torneo 1" />
            </div>
            ...
            <div className="gridItem tournamentItem">
              ...
              <img src="../../public/img/05-img-costados-larga/9.jpeg" alt="Jugador 1" />
            </div>
            ...
            <div className="gridItem tournamentItem">
              ...
              <img src="../../public/img/05-img-costados-larga/10.jpeg" alt="Torneo 2" />
            </div>
          </div>
        </section>
        ...
        <section className="casinoSection">
          ...
          <div className="casinoRow">
            <div className="gridItem casinoItem">
              <img src="../../public/img/05-img-costados-larga/11.jpeg" alt="Casino 1" />
            ...
            <div className="gridItem casinoItem">
              <img src="../../public/img/05-img-costados-larga/12.jpeg" alt="Casino 2" />
              <div className="casinoText">
